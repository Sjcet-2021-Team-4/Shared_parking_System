...
<div class='col-md-6'>
	<div class='form-group'>
		...
		<input type='button' name='view' value='Get Location Values' class='form-control btn btn-primary' onclick='getLocation()'>
	</div>
</div>";
...
<form action='select.php' method='post'><input type='submit' name='view' value='View All' class='form-control btn btn-secondary'></form></div></div>
...
";
?>
<div style="width: 100%"><iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=ramapuram,kotayam+(Ramapuram)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://www.google.com/maps">Google Map</a></div>
<?php
mysqli_close($con);
