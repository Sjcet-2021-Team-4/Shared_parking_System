  ...
  // $i=0;
   echo "<tbody>";
    ...
    $uid = $_SESSION['id'];         
 	...
 	$result = mysqli_query($con,"SELECT s.id, s.pid, s.type, s.slots, s.price, s.status FROM tbl_slots as s INNER JOIN tbl_parking_areas as p WHERE s.pid = p.id AND p.oid = '$uid' ");
