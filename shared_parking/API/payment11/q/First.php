...
header("location:sec.php?ip=$ip&uid=$uid&lid=$lid&bid=$bid&pid=$pid&vehicleType=$vehicleType&vehicleNumber=$vehicleNumber&bdate=$bdate&duration=$duration&amount=$amount");
}
